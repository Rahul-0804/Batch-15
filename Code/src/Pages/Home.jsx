      ...
      <div className="hero_section">
        <div className="hero_section-container">
          <div className="hero_section-container-left">
            ...
            <p className="home-description">Create Your Resume By employing the best practices and innovative tech, MyFolio boosts your chances of landing a better job.</p>
